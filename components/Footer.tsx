...
export default function Footer() {
  ...
  return (
    <footer className="w-full py-8 px-4 border-t border-gray-200 dark:border-gray-800 snap-end">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-text-light-secondary dark:text-text-dark-secondary">
        <div>
